<footer class="footer">
	...
	<div class="container">
			...
			<div class="container">
				<div class="sitemap__top">
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="sitemap__column">
								...
								<ul class="menu sitemap__links">
									...
									<li><a href="/products/fitingi.php" class="sitemap__link">Фитинги и муфты для РВД</a></li>
						...
						<div class="col-12 d-block d-md-none">
							...
							<div class="sitemap__column no-border">
								<div class="sitemap__links-title">
				...
				<div class="sitemap__bottom">
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="sitemap__links-title">Отдел продаж</div>
							<ul class="menu sitemap__links">
								<li><a href="tel:88125201010" class="sitemap__link">8 (812) 520-10-10</a></li>
							</ul>
						</div>

						<div class="col-12 col-md-6 col-lg-3">
							<div class="sitemap__links-title">Технический отдел</div>
							<ul class="menu sitemap__links">
								<li><a href="tel:88125201010" class="sitemap__link">8 (812) 520-10-10</a></li>
							</ul>
						</div>
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="sitemap__links-title">Тендерный отдел</div>
							<ul class="menu sitemap__links">
								<li><a href="tel:88125201010" class="sitemap__link">8 (812) 520-10-10</a></li>
							</ul>
						</div>
						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="sitemap__links-title">Финансовый отдел</div>
							<ul class="menu sitemap__links">
								<li><a href="tel:88125201010" class="sitemap__link">8 (812) 520-10-10</a></li>
							</ul>
						</div>
		...
		<p class="footer__info">Данный сайт носит исключительно информационный характер и ни при каких условиях не является публичной офертой, определяемой положениями статьи 437 ГК РФ. Для получения актуальной информации о наличии и стоимости товаров и услуг, представленных на сайте, обращайтесь по телефону <a href="tel:8125021212" class="nowrap">(812) 502-12-12</a> и e-mail <a href="mailto:office@gizs.ru">office@gizs.ru</a>.</p>
