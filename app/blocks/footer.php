						...
						<div class="col-12 col-md-6 col-lg-3">
							<div class="sitemap__column">
								...
								<ul class="menu sitemap__links">
									...
									<li><a href="#" class="sitemap__link">Применение продукции</a></li>
