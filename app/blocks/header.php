<header class="header">
	...
	<div class="top-line">
				...
				<div class="col-12 col-md-4 col-lg-3">
					<div class="logo desktop-logo">
						<div class="row no-gutters align-items-center">
							<div class="col-auto">
								<div class="logo__img">
										<a href="index.php" class="d-none d-md-block"><img src="img/logo.png" class="img-responsive" alt="Логотип" 
											srcset="img/logo.png 1x, img/logo@2x.png 2x"></a>
										<a href="index.php" class="d-md-none"><img src="img/logo--white.png" class="img-responsive" alt="Логотип"></a>
								</div>
							</div>
							<div class="col-auto">
		...
		<a href="#" class="contacts__hidden-tel d-block d-lg-none"></a>
		...
		<div class="container">
			<div class="row no-gutters">
				...
				<div class="col-auto d-flex align-items-center">
					<div class="logo">
						<div class="logo__img">
								<a href="index.php" class="d-none d-md-block"><img src="img/logo--white.png" class="img-responsive" alt="Логотип"></a>
						</div>
					</div>
				</div>
