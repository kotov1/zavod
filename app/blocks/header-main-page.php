<header class="header">
	...
	<nav class="mobile-nav">
		...
		<div class="sitemap mobile-sitemap">
			...
			<div class="sitemap__links-title"><i class="icon icon-mob3"></i>Услуги</div>
			<ul class="menu sitemap__links">
				<li><a href="#" class="sitemap__link">Сервис</a></li>
				<li><a href="#" class="sitemap__link">Нестандартные компоненты</a></li>
			</ul>
			...
			<div class="sitemap__links-title"><i class="icon icon-mob4"></i>Партнерам</div>
			<ul class="menu sitemap__links">
			...
			<div class="sitemap__links-title"><i class="icon icon-mob6"></i>Каталоги</div>
			<ul class="menu sitemap__links">
