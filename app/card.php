	...
	<div class="page card-page">
		...
		<main class="content">
			...
			<div class="productCart">
				...
				<section class="productCart__top">	
					<div class="container">
						<div class="row justify-content-md-center align-items-start">
							...
							<div class="col-12">
								...
								<div class="productCart__descTop">
									<h2>Муфта Interlock для РВД R13/R15</h2>
									<h4>Заголовок 1</h4>
				...
				</section><!-- productCart__top -->
		
	
				<section class="productCart__characteristics">
					<div class="container">
						<div class="row">
							<div class="col-12">
